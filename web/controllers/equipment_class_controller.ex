defmodule PharNote.EquipmentClassesController do
  ...
  #         {:ok, newEquipmentClasses} ->
  #           #strip out the equipment_class_roles field - either that or do a cast_assoc on it
  #           u2 = %PharNote.EquipmentClasses{ newEquipmentClasses | equipment_class_roles: []}  #or nil
